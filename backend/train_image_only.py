"""
Standalone Image Model Training Script
Trains EfficientNetB3 model independently
"""
...
class ImageDataProcessor:
    ...
    def process_video(self, video_path, label):
        """Process video: extract first frame and face"""
        try:
    ...
    def load_dataset(self, real_dir, fake_dirs, max_samples=None):
        ...
        if real_path.exists():
            video_files = sorted(real_path.glob("*.mp4"))[:200]
...
class ImageDetectionModelTrainer:
    ...
    def plot_training_history(self, save_path='models/image_training_history.png'):
...
def main():
    ...
    logger.info("=" * 70)
    logger.info("IMAGE MODEL TRAINING - STANDALONE")
    logger.info("=" * 70)
    ...
    try:
        ...
        trainer = ImageDetectionModelTrainer()
        ...
        trainer.save_model('models/efficientnet_model.h5')
